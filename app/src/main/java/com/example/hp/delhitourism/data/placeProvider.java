...
public class placeProvider extends ContentProvider {
    ...
    private static final int TOURIST_PLACE = 100;

    /** URI matcher code for the content URI for a single pet in the pets table */
    private static final int TOURIST_PLACE_ID = 101;
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(placeContract.CONTENT_AUTHORITY, placeContract.PATH_PLACE, TOURIST_PLACE);
        ...
        sUriMatcher.addURI(placeContract.CONTENT_AUTHORITY, placeContract.PATH_PLACE + "/#", TOURIST_PLACE_ID);
    }
    ...
    private Uri insertPlace(Uri uri, ContentValues values) {
        ...
        /*Integer star = values.getAsInteger(placeEntry.COLUMN_PLACE_STAR_RATING);
        if (star == null || star>5) {
            throw new IllegalArgumentException("Place requires valid gender");
        }
